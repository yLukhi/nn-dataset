...
class DPNBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        model_class = nn.Sequential(nn.Conv2d(3, 64, kernel_size=19, stride=2, padding=6),nn.ReLU(inplace=True),nn.MaxPool2d(kernel_size=13, stride=4, padding=1),nn.Conv2d(64, 192, kernel_size=11, stride=1, padding=0),nn.ReLU(inplace=True),nn.MaxPool2d(kernel_size=2, stride=2, padding=0),nn.Conv2d(192, 384, kernel_size=3, stride=1, padding=1),nn.ReLU(inplace=True),nn.Conv2d(384, 256, kernel_size=3, stride=1, padding=1),nn.ReLU(inplace=True),nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1),nn.ReLU(inplace=True),nn.MaxPool2d(kernel_size=2, stride=2, padding=0))(self.device)
