...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
                ...
                self.features = nn.Sequential(FractalUnit(in_channels=in_shape[1] if len(in_shape) == 4 else in_shape[0], out_channels=64, num_columns=2, loc_drop_prob=0.15, dropout_prob=0.3))
