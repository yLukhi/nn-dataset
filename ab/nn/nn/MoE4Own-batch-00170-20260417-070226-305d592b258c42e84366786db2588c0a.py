# Auto-generated 4-Expert Heterogeneous MoE: AirNet + ConvNeXt + MobileNetV2 + SqueezeNet-1
...
# ============================================================================
# HETEROGENEOUS MOE NET — AirNet + ConvNeXt + MobileNetV2 + SqueezeNet_1
# ============================================================================
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
