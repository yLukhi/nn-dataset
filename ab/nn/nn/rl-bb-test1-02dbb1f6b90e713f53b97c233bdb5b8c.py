...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
            ...
            self.backbone_a = TorchVision("regnet_x_800mf", in_channels=in_shape[1] if in_shape[1] == 3 else 3)
            self.backbone_b = TorchVision("squeezenet1_0", in_channels=in_shape[1] if in_shape[1] == 3 else 3)
