# Auto-generated 4-Expert Heterogeneous MoE: AirNet + AlexNet + GoogLeNet + MobileNetV3
...
def supported_hyperparameters():
    return {'dropout', 'dropout_aux', 'lr', 'momentum', 'norm_eps', 'norm_momentum'}
...
# ============================================================================
# HETEROGENEOUS MOE NET — AirNet + AlexNet + GoogLeNet + MobileNetV3
# ============================================================================
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
