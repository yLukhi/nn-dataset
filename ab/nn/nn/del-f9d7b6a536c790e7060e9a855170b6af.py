...
class ModuleWrapper(nn.Module):
    ...
    def forward(self, x):
        ...
        return x, kl
        self.conv2 = BBBConv2d(64, 192, 5, padding=2, bias=True, priors={'prior_mu': 0, 'prior_sigma': 0.1, 'posterior_mu_initial': (0.013793407076213232, 0.3990074422788457), 'posterior_rho_initial': (-1.3006997474841578, 0.2382165379587329)})
