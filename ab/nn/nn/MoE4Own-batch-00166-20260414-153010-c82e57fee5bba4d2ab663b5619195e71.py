# Auto-generated 4-Expert Heterogeneous MoE: AirNet + ConvNeXt + DPN131 + ShuffleNet
...
def supported_hyperparameters():
    return {'lr', 'momentum', 'norm_eps', 'norm_std', 'stochastic_depth_prob'}
...
# ============================================================================
# HETEROGENEOUS MOE NET — AirNet + ConvNeXt + DPN131 + ShuffleNet
# ============================================================================
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
