...
class BagNetUnit(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride):
        ...
        self.body = BagNetBottleneck(in_channels, out_channels, kernel_size, stride, bottleneck_factor=1)

        if self.resize_identity:
            self.identity_conv = self.conv1x1_block(in_channels, out_channels, activation=True)
    ...
    def forward(self, x):
        ...
        return self.activ(x + identity) # ADDED BY OLYA-102
