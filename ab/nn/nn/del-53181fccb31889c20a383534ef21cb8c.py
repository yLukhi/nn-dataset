...
class DPNBlock(nn.Module):
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.conv1 = nn.Conv2d(
            in_channels, out_channels, kernel_size=3, stride=stride, padding=1, groups=2, bias=False
        )
...
# Memory-Optimized DPN107
        self.conv2 = nn.Conv2d(out_channels, 338, kernel_size=3, padding=1, groups=256, bias=True)
