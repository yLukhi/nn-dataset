# Auto-generated 4-Expert Heterogeneous MoE: AirNet + ConvNeXt + DPN131 + GoogLeNet
...
class DPN131Expert(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super(DPN131Expert, self).__init__()
        self.device = device
        model_class = DPN131
...
# ============================================================================
# HETEROGENEOUS MOE NET — AirNet + ConvNeXt + DPN131 + GoogLeNet
# ============================================================================
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
        ...
        self.experts = nn.ModuleList([
            ...
            DPN131Expert(in_shape, out_shape, prm, device),
