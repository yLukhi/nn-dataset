# Auto-generated 4-Expert Heterogeneous MoE: AirNet + AirNext + GoogLeNet + SqueezeNet-1
...
def supported_hyperparameters():
    return {'dropout', 'dropout_aux', 'lr', 'momentum'}
...
# ============================================================================
# HETEROGENEOUS MOE NET — AirNet + AirNext + GoogLeNet + SqueezeNet_1
# ============================================================================
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
