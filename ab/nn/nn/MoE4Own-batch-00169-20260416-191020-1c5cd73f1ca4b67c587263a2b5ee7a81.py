# Auto-generated 4-Expert Heterogeneous MoE: AirNet + ConvNeXt + GoogLeNet + SqueezeNet-1
...
def supported_hyperparameters():
    return {'dropout', 'dropout_aux', 'lr', 'momentum', 'norm_eps', 'norm_std', 'stochastic_depth_prob'}
...
class GoogLeNetExpert(nn.Module):
...
class SqueezeNet_1Expert(nn.Module):
...
def _squeezenet(
    ...
    model = SqueezeNet_1Expert(version, **kwargs)
    if weights is not None:
...
# ============================================================================
# HETEROGENEOUS MOE NET — AirNet + ConvNeXt + GoogLeNet + SqueezeNet_1
# ============================================================================
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
        ...
        prm.setdefault('dropout_aux', 0.5)
        ...
        self.experts = nn.ModuleList([
            ...
            GoogLeNetExpert(in_shape, out_shape, prm, device),
            SqueezeNet_1Expert(in_shape, out_shape, prm, device),
        ])
