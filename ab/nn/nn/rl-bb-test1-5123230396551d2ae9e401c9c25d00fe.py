...
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
                ...
                self.backbone_a = TorchVision(model='regnet_x_800mf', in_channels=self._input_spec[0])
                self.backbone_b = TorchVision(model='shufflenet_v2_x2_0', in_channels=self._input_spec[0])
