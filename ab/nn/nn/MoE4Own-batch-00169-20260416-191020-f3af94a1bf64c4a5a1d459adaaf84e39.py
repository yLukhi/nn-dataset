# Auto-generated 4-Expert Heterogeneous MoE: AirNet + ConvNeXt + GoogLeNet + SwinTransformer
...
def supported_hyperparameters():
    return {'attention_dropout', 'dropout', 'dropout_aux', 'lr', 'momentum', 'norm_eps', 'norm_std', 'stochastic_depth_prob'}
...
# ============================================================================
# HETEROGENEOUS MOE NET — AirNet + ConvNeXt + GoogLeNet + SwinTransformer
# ============================================================================
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
