# Auto-generated 4-Expert Heterogeneous MoE: AirNet + ConvNeXt + MobileNetV3 + SwinTransformer
...
def supported_hyperparameters():
    return {'attention_dropout', 'dropout', 'lr', 'momentum', 'norm_eps', 'norm_momentum', 'norm_std', 'stochastic_depth_prob'}
...
# ============================================================================
# HETEROGENEOUS MOE NET — AirNet + ConvNeXt + MobileNetV3 + SwinTransformer
# ============================================================================
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
