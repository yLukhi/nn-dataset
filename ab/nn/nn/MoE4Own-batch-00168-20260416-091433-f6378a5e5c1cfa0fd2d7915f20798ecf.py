# Auto-generated 4-Expert Heterogeneous MoE: AirNet + ConvNeXt + GoogLeNet + MobileNetV3
...
def supported_hyperparameters():
    return {'dropout', 'dropout_aux', 'lr', 'momentum', 'norm_eps', 'norm_momentum', 'norm_std', 'stochastic_depth_prob'}
...
# ============================================================================
# HETEROGENEOUS MOE NET — AirNet + ConvNeXt + GoogLeNet + MobileNetV3
# ============================================================================
class Net(nn.Module):
    def __init__(self, in_shape: tuple, out_shape: tuple, prm: dict, device: torch.device) -> None:
        super().__init__()
